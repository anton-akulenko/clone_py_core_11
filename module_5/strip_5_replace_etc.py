...
------
Провести валідацію списка телефонів
Телефон: +380501234567 Де: +380 код країни, телефон 501234567
Будмо думати, що телефон вірний з кодом країни і без нього
"""
...
if __name__ == '__main__':
    for phone in phone_storage:
        ...
        if is_valid:
            print("Телефон {:>12} вірний".format(phone))
        else:
            print("Телефон {:>12} не вірний".format(phone))